...
<div class="signup_cp">
    ...
    <div class="signup_cp_box">
        <dl class="signup_cp_1">
            <dt>아이디</dt>
            <dd>acemall</dd>
        </dl>

        <dl class="signup_cp_2">
            <dt>이름</dt>
            <dd>전찬혁</dd>
        </dl>

        <dl class="signup_cp_3">
            <dt>이메일</dt>
            <dd>ace@naver.com</dd>
        </dl>
    </div>

    <div class="signup_cp_btn">
        <div class="signup_cp_btn1"><a href="../index.php">NEW 상품 보러가기</a></div>
        <div class="signup_cp_btn2"><a href="../login/login.php">로그인</a></div>
    </div>
</div>
