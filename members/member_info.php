...
<header id="header" class="header">
  ...
  <div class="join_box">
    ...
    <form class="join_form" name="edit_form" action="edit.php" method="post" onsubmit="return edit_form_check()">
      ...
      <div class="id_box">
        <label for="u_id" class="left_box">아이디<span class="identify">*</span></label>
      ...
      <div class="gender_box">
        ...
        <div class="gender_sub_box">
          ...
          <div>
            <input type="radio" name="gender" id="no" value="n"<?php if($array["gender"] == "n") echo " checked";?>>
    ...
    <div class="join_submit_box">
      <button class="edit_btn" type="submit">정보수정</button>
