...
<div class="notice_box">
  ...
  <div class="notice_box2">
    <h3>1:1 문의 내역</h3>  
      ...
      <div class="list">
        <a class="modify_btn" href="modify.php?n_idx=<?php echo $n_idx; ?>">수정</a>
        <a class="remove_btn" href="delete.php" onclick="remove_notice()">삭제</a>
      </div>
  </div>  
</div>
