    ...
    <div class="notice_box">
        ...
        <div class="notice_box2">
            ...
            <div class="notice_form">
                <form name="notice_form" action="edit.php?n_idx=<?php echo $n_idx; ?>" method="post" onsubmit="return form_check()">
                    ...
                    <div class="notice_form_box2">
                        ...
                        <div class="notice_form_txt3">
                            <textarea name="n_content" id="n_content" inputmode="text"
                                aria-label="textarea-message"><?php echo $array["n_content"]; ?></textarea>
