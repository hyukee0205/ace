...
<body>
    ...
    <div class="order_page">
        <div class="check_icon">확인</div>

        <div class="order_text">
            <h2 class="order_text_1"><?php echo $s_name; ?>님의 주문이 완료되었습니다.</h2>
            <p class="order_text_2">내일 아침에 만나요 !</p>
        </div>

        <div class="order_money">
            <p class="order_money_1">결제 금액</p>
            <p class="order_money_2">41,880원</p>
        </div>
        ...
        <div class="order_check">
            <p class="order_check_1">· [배송준비중] 이전일 때 주문내역 상세페이지에서 주문 취소가 가능합니다.</p>
            <p class="order_check_2">· 엘레베이터 이용이 어려운 경우 6층 이상부터는 공동 현관 앞 또는 경비실
                로 대응 배송 될 수 있습니다.</p>
            <p class="order_check_3">· 주문 / 배송 및 기타 문의가 있을 경우, 1:1문의에 남겨주시면 신속히 해결
                해드리겠습니다.</p>
        </div>
        ...
        <div class="order_content">
            <button type="button" onclick="location.href='basket.php'">주문 상세보기</button>
        </div>

        <div class="shop_page">
            <button type="button" onclick="location.href='../index.php'">쇼핑 계속하기</button>
        </div>
