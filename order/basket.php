...
<head>
    ...
    <script src="https://kit.fontawesome.com/365988b5b6.js" crossorigin="anonymous"></script>
...
<body>
    ...
    <h2 class="basket_title">장바구니</h2>

    <div class="basket_box">
        <div class="basket_chkbox">

            <div class="chk_box1">
                <label for="selectall">
                    <input type="checkbox" id="selectall" name="selectall" onclick='selectAll(this)'>
                    <i class="chk_icon"></i>전체선택 (2/2)</label>
            </div>


            <div class="chk_box_2">
                <div class="chk_box_inner_1">
                    <div>
                        <label for="chk_1">
                            <input type="checkbox" id="chk_1" name="chk" onclick='checkSelectAll()'>
                            <i class="chk_icon"></i>청송 사과 3kg (7~9입)</label>
                    </div>
                    <div class="basket_count">2개</div>
                    <div class="basket_price_inner">
                        <div class="basket_price1">25,760원</div>
                        <div class="basket_price2">36,800원</div>
                    </div>
                </div>
                ...
                <div class="chk_box_inner_2">
                    <div>
                        <label for="chk_2">
                            <input type="checkbox" id="chk_2" name="chk" onclick='checkSelectAll()'>
                            <i class="chk_icon"></i>모나카 아이스크림 2종</label>
                    </div>
                    <div class="basket_count">1개</div>
                    <div class="basket_price_inner">
                        <div class="basket_price1 basket_price_1">10,430원</div>
                        <div class="basket_price2">14,900원</div>
                    </div>
                </div>
            </div>
        ...
        <div class="basket_paybox">
            <div class="basket_paybox_border">
                <div class="basket_paybox_1">
                    <p class="basket_paybox_1_1">배송지</p>
                    <p class="basket_paybox_1_2">경기도 안산시 상록구 도매시장로24 (이동)</p>
                    <button type="button"><a class="basket_paybox_1_3" href="#">배송지 변경</a></button>
                </div>

                <div class="basket_paybox_2">
                    <ul class="basket_paybox_2_1">
                        <li>상품금액</li>
                        <li>51,700원</li>
                    </ul>

                    <ul class="basket_paybox_2_2">
                        <li>상품할인금액</li>
                        <li>-15,510원</li>
                    </ul>

                    <ul class="basket_paybox_2_3">
                        <li>배송비</li>
                        <li>0원</li>
                    </ul>

                    <ul class="basket_paybox_2_4">
                        <li>결제금액</li>
                        <li class="basket_paybox_2_4_1">36,190원</li>
                    </ul>

                    <ul class="basket_paybox_2_5">
                        <li class="basket_paybox_2_5_1">적립</li>
                        <li class="basket_paybox_2_5_2">최대 1,445원 적립</li>
                        <li class="basket_paybox_2_5_3">웰컴 5%</li>
                    </ul>
                </div>
            </div>


            <div class="basket_paybox_3">
                <form name="basket_form" action="order_list.php" method="get" onsubmit="return form_check()">
                    <button type="submit">
                        주문하기
                    </button>
                </form>
            ...
            <div class="basket_note">
                <ul>
                    <li>· 쿠폰/적립금은 주문서에서 사용 가능합니다.</li>
                    <li>· [주문완료] 상태일 경우에만 주문 취소 가능합니다.</li>
                    <li>· [acemall>주문내역 상세페이지]에서 직접 취소하실 수 있습니다.</li>
                    <li>· 쿠폰, 적립금은 사용 금액을 제외한 실 결제 금애 기준으로 최종 산정됩니다.</li>
                    <li>· 상품별로 적립금 지급 기준이 다를 수 있습니다.(상품 상세페이지에서 확인 가능합니다.)</li>
                </ul>
            </div>
